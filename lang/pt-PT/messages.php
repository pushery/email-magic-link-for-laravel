...
// European Portuguese, in the TU form: pt-PT = tu, pt-BR = você, and carrying
// that difference is the only reason this split exists. The base bundle is
// written in the você form, which is correct Portuguese but formal and distant
...
return [
    ...
    'confirm_intro' => 'Para tua segurança, confirma que pretendes iniciar sessão.',
    ...
    'invitation_failed' => 'Este convite é inválido ou expirou. Pede um novo a quem te convidou.',
